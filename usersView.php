...
<div class="container-fluid">
  ...
  <div id="topMenu">
    <button id="viewTakenExam" type="button" onclick="viewTakenExam()" class="btn ucf-colors m-3">Taken Exam</button>
    <button id="viewNotFinished" type="button" onclick="viewNotFinished()" class="btn ucf-colors m-3">Aborted/In-Progress</button>
    <button id="viewNotTakenExam" type="button" onclick="viewNotTakenExam()" class="btn ucf-colors m-3">Not Taken Exam</button>
    <button id="viewFaculty" type="button" onclick="viewFaculty()" class="btn ucf-colors m-3">Faculty</button>
    <button id="viewAll" type="button" onclick="viewAll()" class="btn ucf-colors m-3">All Users</button>
  </div>
  
  <table id="mytable"></table>
  
  <button id="clrButton" type="button" onclick="hideClrButton()" class="btn ucf-colors m-3" style="display: none;">Clear Table</button>
  <table id="detailtable" class="table-sm table-striped"></table>
  <div id="message"></div>
...
<script src="./js/usersView.js" defer></script>
