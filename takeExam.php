...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col pt-2 ucf-colors">Time Remaining: <span id="countdown"></span></div>
    </div>

    <h3><span id="examProgress"></span></h3>

    <div class="m-3">
      <span id="stemHere"></span>
    </div>

    <div id="requiredChoiceA" class="form-check m-3">
      <label class="form-check-label">
        <input type="radio" class="form-check-input" name="optchoices" value="a">
        <span id="choiceA"></span>
      </label>
    </div>

    <div id="requiredChoiceB" class="form-check m-3">
      <label class="form-check-label">
        <input type="radio" class="form-check-input" name="optchoices" value="b">
        <span id="choiceB"></span>
      </label>
    </div>

    <div id="optionalChoiceC" class="form-check m-3">
      <label class="form-check-label">
        <input type="radio" class="form-check-input" name="optchoices" value="c">
        <span id="choiceC"></span>
      </label>
    </div>

    <div id="optionalChoiceD" class="form-check m-3">
      <label class="form-check-label">
        <input type="radio" class="form-check-input" name="optchoices" value="d">
        <span id="choiceD"></span>
      </label>
    </div>

    <div id="optionalChoiceE" class="form-check m-3">
      <label class="form-check-label">
        <input type="radio" class="form-check-input" name="optchoices" value="e">
        <span id="choiceE"></span>
      </label>
    </div>

    <button id="previous" type="button" onclick="previous()" class="btn ucf-colors m-3">Previous</button>
    <button id="next" type="button" onclick="next()" class="btn ucf-colors m-3">Next</button>
    <button id="finish" type="button" onclick="finish()" class="btn btn-danger m-3">Finish Exam</button>
