...
<body>
  ...
  <?php include_once 'header.php';?>
    <div class="container col-12">
      ...
      <label for="examID">Select Exam (Only Exams without historical records can be changed): </label>
        <div class="form-group d-flex" id="toolbar">     
          <select id="examID" name="examID" class="form-control" onchange="selectedExam()">
            <?php
          ...
          <button onclick="updateQuestions()" id="done" class="btn btn-ucf col-3">Add Users</button>
        </div>
      <!-- </form> -->
  ...
  <script src="./js/assignUsers.js"></script>
</body>
</html>