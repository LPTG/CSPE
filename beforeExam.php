...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="col-10" style="text-align:center"><h1>Instructions<h1></div>
    ...
    // Get instructions
    $data = $pdo->query('SELECT * FROM instructions')->fetchAll();

    // Display Instructions
    echo '<div class="col-10">';
    echo $data[0]["instructions"];
    echo '</div>';
    ?>

    <br>

    <a href="cspe-instructions.pdf" download>Download these instructions</a>
    <br><br>
    <button class="ucf-colors" onclick="startExam()">Start Exam</button>
  </div>
  ...
  <script src="./js/beforeExam.js"></script>
