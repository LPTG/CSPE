...
// Retrieve all rows
$data = $pdo->query('(SELECT name, COUNT(DISTINCT(q.category)) AS usedBefore FROM categories c LEFT JOIN questions q ON c.name=q.category GROUP BY name)')->fetchAll();
