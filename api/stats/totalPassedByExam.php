...
$data = $pdo->query('SELECT e.examID, COUNT(*) AS total FROM users u, exams e WHERE u.examId = e.examID AND u.examScore IS NOT NULL AND u.examScore >= e.passFailPct GROUP BY examID')->fetchAll();
