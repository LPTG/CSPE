...
// Pass counts for individual questions
$data = $pdo->query('SELECT questionID, COUNT(*) AS total FROM results WHERE answered=correctAnswer GROUP BY questionID')->fetchAll();
