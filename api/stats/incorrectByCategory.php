...
// Number of times questions were answered incorrectly by testing focus area or category
$data = $pdo->query('SELECT q.category, COUNT(*) AS total FROM questions q, results r WHERE q.questionID = r.questionID AND r.answered <> r.correctAnswer GROUP BY q.category')->fetchAll();
