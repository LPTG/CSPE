...
// Number of questions in pool for each testing focus area or category
$data = $pdo->query('SELECT category, COUNT(*) AS total FROM questions GROUP BY category')->fetchAll();
