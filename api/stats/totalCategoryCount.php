...
// Number of questions administered across all exams by category 
$data = $pdo->query('SELECT q.category, COUNT(*) AS total FROM questions q, results r WHERE q.questionID = r.questionID GROUP BY q.category')->fetchAll();
