...
// Number of students who did not answer every question on their exam (left some answers NULL)
$data = $pdo->query('SELECT COUNT(DISTINCT id) AS total FROM results WHERE answered = "z"')->fetchAll();
