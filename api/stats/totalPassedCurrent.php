...
// For each exam in system taken by students, number of students who passed that exam
$data = $pdo->query('SELECT e.examID, COUNT(*) AS total FROM users u, exams e WHERE u.examId = e.examID AND u.examScore IS NOT NULL AND u.examScore >= e.passFailPct AND e.current == 1 GROUP BY examID')->fetchAll();
