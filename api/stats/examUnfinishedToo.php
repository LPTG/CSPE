...
// Number of students already taken exam (includes those that started but never finished exam)
$data = $pdo->query('SELECT COUNT(id) AS total FROM users WHERE examDate IS NOT NULL AND isADMIN = 0')->fetchAll();
