...
// Number of students already taken exam (only those that finished exam by clicking finish or by timer expiring)
$data = $pdo->query('SELECT COUNT(DISTINCT id) AS total FROM timelog WHERE actionWord = "finish"')->fetchAll();
