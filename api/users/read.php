...
// Retrieve all rows
$data = $pdo->query('SELECT id, firstName, lastName,  uploadDate, examID, examTimeLimit, examDate, date_format(examStartTime, "%r") as examStartTime, date_format(examEndTime, "%r") as examEndTime, examScore, isAdmin FROM users')->fetchAll();
