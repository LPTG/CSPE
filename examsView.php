...
<body>
  ...
  <div class="container-fluid">
    ...
    <!-- Button Group -->
    <div id="topMenu">
      <button id="viewAll" type="button" onclick="viewAll()" class="btn ucf-colors m-3">All Exams</button>
      <button id="viewCurrent" type="button" onclick="viewCurrent()" class="btn ucf-colors m-3">Current Exam</button>
      <button id="viewPast" type="button" onclick="viewPast()" class="btn ucf-colors m-3">Other Exams</button>
    </div>
    ...
    <div class="container col-10 ">
      <table id="mytable" class="table-borderless table-striped"><thead class="thead-secondary"></thead></table>
    </div>

    <div class="container col-10 ">
      <button id="clrButton" type="button" onclick="hideClrButton()" class="btn ucf-colors m-3" style="display: none;">Clear Table</button>
      <table id="detailTable" class="table-borderless table-striped"><thead class="thead-secondary"></thead></table>
    </div>
  ...
  <script src="./js/examsView.js" defer></script>
