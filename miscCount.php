...
<div class="container-fluid">
  ...
  <div class="row">
      ...
      <table class="table table-bordered table-striped">
        ...
        <tbody>
         <tr>
          ...
          <tr>
            <th scope="row">Aborted/In-Progress</th>
            <td><span id="proNum"></span></td>
          </tr>
          <tr>
            <th scope="row">Not Taken</th>
            <td><span id="notTaken"></span></td>
          </tr>
          <tr>
          ...
          <tr>
            <th scope="row">Completion Times</th>
    ...
    <div class="col-6">
      <h2>Total Questions by Exam</h2>
      <table id="TotalQuestionsbyExam" class="table table-bordered table-striped"></table>
    </div>

    <div class="col-6">
      <h2>Total Questions by Category</h2>
      <table id="TotalQuestionsbyCategory" class="table table-bordered table-striped"></table>
    </div>
...
<script src="./js/miscCount.js" defer></script>
