...
<div class="container-fluid">
  ...
  <button id="studentHistogram" type="button" onclick="studentHistogram()" class="btn ucf-colors m-3">Student Overall</button>
  <button id="byExamGroup" type="button" onclick="byExamGroup()" class="btn ucf-colors m-3">By Exam Group</button>
  <button id="byExam" type="button" onclick="byExam()" class="btn ucf-colors m-3">By Exam</button>
  <button id="byCategory" type="button" onclick="byCategory()" class="btn ucf-colors m-3">By Category</button>
  <button id="byQuestion" type="button" onclick="byQuestion()" class="btn ucf-colors m-3">By Question</button>
...
<script src="./js/passFail.js" defer></script>
